...
| [democratized-medicine](docs/experiments/democratized-medicine/) | The Pirate Pharmacy Question: Which parts of medicine could actually be made at city-to-community scale, and how soon? We scored nine domains on societal benefit against demonstrated small-scale feasibility — and found the bottleneck is almost never synthesis. It is sterility and quality control. The highest-leverage build is not a new reactor; it is an open QC commons. Every academic claim verified against Crossref/OpenAlex, one retracted source caught and excluded. | [View](https://nimblecoorg.github.io/open-science/experiments/democratized-medicine/) |
| [dst-map](docs/experiments/dst-map/) | Daylight Saving in Aotearoa: Three Clock Futures: Is NZ really scrapping daylight saving? An interactive regional map of three clock policies — keep, abolish, permanent NZDT — with health, safety and energy evidence weighed honestly (14 citations verified, none retracted). | [View](https://nimblecoorg.github.io/open-science/experiments/dst-map/) |
